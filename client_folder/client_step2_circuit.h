...
share* sigma0(share** s_h, BooleanCircuit* circ);
share* ma(share** s_h, BooleanCircuit* circ);
share* sigma1(share** s_h, BooleanCircuit* circ);
share* ch(share** s_h, BooleanCircuit* circ);
